export function HeroSection() {
  return (
    <section className="w-full min-h-screen pt-20 bg-gradient-to-br from-secondary via-background to-background relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between gap-12 relative z-10">
        {/* Left Content */}
        <div className="flex-1 py-20">
          <div className="space-y-6">
            <h2 className="text-sm font-semibold text-accent tracking-widest uppercase">Welcome to Attuluri Events</h2>
